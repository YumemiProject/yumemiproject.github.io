...
const changelog = computed(() => {
  const flavoredString = (release[type].body ?? "")
    ...
    .replace("https://github.com/UsagiApp/Usagi/releases", withBase("/changelogs/"))
    .replace(/## [ \t]*([^\n\r]*)/g, "### $1");
...
<template>
  ...
  <footer class="full-changelog">
    <p>
      ...
      <a class="full-changelog__link" href="https://github.com/UsagiApp/Usagi/releases/latest" target="_blank" rel="noopener"> here </a>
    </p>
  </footer>
</template>
