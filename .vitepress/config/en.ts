...
export const SITE_NAME = "Usagi Website";
...
export const config: LocaleConfig<ThemeConfig> = {
  root: {
    ...
    themeConfig: {
      ...
      editLink: {
        pattern: "https://github.com/YumemiProject/yumemiproject.github.io/edit/main/website/:path",
...
function getFooter(): CustomConfig["footer"] {
  return {
    ...
    qrcodeLink: "https://t.me/UsagiApp",
    navigation: [
      {
        title: "Legal",
        items: [
