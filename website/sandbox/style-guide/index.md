...
- **DO** use **[Shortcodes](https://github.com/YumemiProject/yumemiproject.github.io/.vitepress/config/shortcodes.ts)** items when applicable:
...
- **DO** include related info as an aside object:
  ...
  > **Lorem ipsum** dolor sit amet, _consectetur_ adipiscing **elit**.
  > ::: tip Note
  > Related GitHub issue: [#1](https://github.com/UsagiApp/Usagi/issues/1)
  > :::
