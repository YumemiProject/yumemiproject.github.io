...
1. **Restart Usagi**: Force close and reopen the app.
...
If none of these solutions help, try asking in our [Telegram group](https://t.me/UsagiApp).
...
If you're the only one facing a problem, you might be encountering an IP ban, or other countermeasures set by website owners against programs like **Usagi**.
...
When everyone experiences a problem, it could be with the app or with the plugin that provides that source:

1. Check open issues for [Usagi](https://github.com/UsagiApp/Usagi/issues).
1. Check issues/releases in the plugin repository you imported.
1. If not found, create an issue in the correct repository (Usagi app or plugin repository).
